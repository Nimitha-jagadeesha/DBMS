...
urlpatterns = [
    ...
    path('list_contracts/<str:username>', views.UserContractsListView.as_view(), name='list_contracts'),
    path('list_staff_contract/', views.list_contracts, name='list_staff_contract'),
    path('add_items/', views.add_products, name='add_items'),
    path('place_order/', views.OrderCreateView.as_view(), name='place_order'),
    path('make_contract/', views.ContractCreateView.as_view(), name='make_contract'),
